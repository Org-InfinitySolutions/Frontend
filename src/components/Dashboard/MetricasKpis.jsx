...
const MetricasKpis = () => {
  ...
  return (
    <div className="grid grid-cols-3 gap-4 mb-8">
      <div className="border-2 border-black rounded-lg p-6 flex flex-col gap-2 bg-white min-h-[90px] justify-between">
      ...
      <div className="border-2 border-black rounded-lg p-6 flex flex-col items-center justify-center bg-white min-h-[90px]">
